...
def run_rollup_aggregation_guest(
    ...
    Returns: FinalizationSubmission with computed public inputs and preimage data.
    The proof bytes are generated by the zkVM and attached at the prover layer.
    """
